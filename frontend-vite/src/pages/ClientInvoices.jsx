        ...
        <div className="space-y-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-8 border border-slate-200 rounded-sm shadow-sm relative overflow-hidden group">
                    ...
                    <p className="text-4xl font-black text-emerald-600 italic tabular-nums">${totalPaid.toLocaleString()}</p>
                                ...
                                <tr key={invoice._id} className="hover:bg-slate-50 transition-all group">
                                    ...
                                    <td className="px-8 py-6 text-right">
                                        <Link
                                            ...
                                            className="inline-flex items-center space-x-2 text-emerald-600 hover:text-emerald-700 font-black uppercase italic text-[10px] border-2 border-emerald-500 px-4 py-2 rounded-sm hover:bg-emerald-50 transition-all"
                                        >
                                            <Eye size={14} />
            ...
            <div className="bg-slate-900 p-8 rounded-sm shadow-xl flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <button className="whitespace-nowrap bg-emerald-500 text-white px-8 py-4 rounded-sm font-black uppercase italic tracking-widest shadow-lg shadow-emerald-900/20 hover:bg-emerald-600 transition-all">
                    Initiate Discussion
                </button>
            </div>
        </div>
